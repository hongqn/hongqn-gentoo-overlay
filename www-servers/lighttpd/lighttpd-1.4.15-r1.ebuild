...
IUSE="bzip2 doc fam fastcgi gdbm ipv6 ldap lua minimal memcache mysql pcre php rrdtool ssl test webdav xattr deflate"
...
src_unpack() {
	...
	if use deflate; then
		epatch ${FILESDIR}/${P}-mod_deflate.diff || die "Patching mod_deflate failed"
	fi
